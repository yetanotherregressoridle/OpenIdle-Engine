...
export type EnemyUnitID = number;
export type ProgressionID = string;

export const MainCharacterPartyUnitID = "player";
export type ThemeID = 'light' | 'dark' | 'system';
export type Tab = 'actions' | 'encounter' | 'inventory' | 'config';
export const DefaultTab = 'actions';
...
export interface Prerequisite {
    ...
    metaProgressionID?: ProgressionID;
}
...
export interface GlobalEffectConfig {
    type: 'increase_value' | 'increase_max' | 'start_encounter' | 'end_encounter' | 'enable_progression' | 'enable_meta_progression' | 'loop';
    amount?: number;
    actionID?: ActionID;
    resourceID?: ResourceID;
    encounterID?: EncounterID;
...
export interface UnitEffectOptions {
    ...
    enemyPartyUnitID?: EnemyUnitID;
    // Target of the effect.
    targetAllyPartyUnitIDs?: PartyUnitID[];
    targetEnemyPartyUnitIDs?: EnemyUnitID[];
    stat?: 'health' | 'mana';
    amount?: number;
}
...
export interface UnitCost {
    target: 'mainCharacter' | 'self' | 'ally' | 'allies' | 'enemy' | 'enemies' | 'all';
    stat: 'health' | 'mana';
    amount: number;
}
